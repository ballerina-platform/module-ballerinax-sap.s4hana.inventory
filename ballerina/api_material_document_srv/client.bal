...
public isolated client class Client {
    ...
    remote isolated function createA_MaterialDocumentHeader(CreateA_MaterialDocumentHeader payload, map<string|string[]> headers = {}) returns A_MaterialDocumentHeaderWrapper|error {
    ...
    # + return - Success 
    remote isolated function createCancel(map<string|string[]> headers = {}, *CreateCancelQueries queries) returns A_MaterialDocumentHeaderWrapper|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Success 
    remote isolated function createCancelItem(map<string|string[]> headers = {}, *CreateCancelItemQueries queries) returns A_MaterialDocumentItemWrapper|error {
    ...
    remote isolated function getA_MaterialDocumentHeader(string MaterialDocumentYear, string MaterialDocument, map<string|string[]> headers = {}, *GetA_MaterialDocumentHeaderQueries queries) returns A_MaterialDocumentHeaderWrapper|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieved entity 
    remote isolated function getA_MaterialDocumentItem(string MaterialDocumentYear, string MaterialDocument, string MaterialDocumentItem, map<string|string[]> headers = {}, *GetA_MaterialDocumentItemQueries queries) returns A_MaterialDocumentItemWrapper|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieved entity 
    remote isolated function getA_SerialNumberMaterialDocument(string Material, string SerialNumber, string MaterialDocument, string MaterialDocumentItem, string MaterialDocumentYear, map<string|string[]> headers = {}, *GetA_SerialNumberMaterialDocumentQueries queries) returns A_SerialNumberMaterialDocumentWrapper|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieved entity 
    remote isolated function getMaterialDocumentHeaderOfA_MaterialDocumentItem(string MaterialDocumentYear, string MaterialDocument, string MaterialDocumentItem, map<string|string[]> headers = {}, *GetMaterialDocumentHeaderOfA_MaterialDocumentItemQueries queries) returns A_MaterialDocumentHeaderWrapper|error {
    ...
    remote isolated function listA_MaterialDocumentHeaders(map<string|string[]> headers = {}, *ListA_MaterialDocumentHeadersQueries queries) returns CollectionOfA_MaterialDocumentHeaderWrapper|error {
        string resourcePath = string `/A_MaterialDocumentHeader`;
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieved entities 
    remote isolated function listA_MaterialDocumentItems(map<string|string[]> headers = {}, *ListA_MaterialDocumentItemsQueries queries) returns CollectionOfA_MaterialDocumentItemWrapper|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieved entities 
    remote isolated function listA_SerialNumberMaterialDocuments(map<string|string[]> headers = {}, *ListA_SerialNumberMaterialDocumentsQueries queries) returns CollectionOfA_SerialNumberMaterialDocumentWrapper|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieved entities 
    remote isolated function listMaterialDocumentItemsOfA_MaterialDocumentHeader(string MaterialDocumentYear, string MaterialDocument, map<string|string[]> headers = {}, *ListMaterialDocumentItemsOfA_MaterialDocumentHeaderQueries queries) returns CollectionOfA_MaterialDocumentItemWrapper|error {
    ...
    # + queries - Queries to be sent with the request 
    # + return - Retrieved entities 
    remote isolated function listSerialNumberssOfA_MaterialDocumentItem(string MaterialDocumentYear, string MaterialDocument, string MaterialDocumentItem, map<string|string[]> headers = {}, *ListSerialNumberssOfA_MaterialDocumentItemQueries queries) returns CollectionOfA_SerialNumberMaterialDocumentWrapper|error {
